...
Этот репозиторий распространяется под лицензией **[GNU General Public License v3.0](LICENSE)** (GPL-3.0).

### Почему GPL-3.0

Модель `EfficientNetV2L.onnx` является производной от проекта [AY000554/ocr_car_plate](https://github.com/AY000554/ocr_car_plate), который лицензирован под **GPL-3.0**. Согласно условиям GPL, производные произведения (включая обученные веса и их распространение) также распространяются под GPL-3.0.

### Источники и связанные лицензии

| Компонент | Лицензия | Ссылка |
|-----------|----------|--------|
| Исходный код и обучение OCR | **GPL-3.0** | [AY000554/ocr_car_plate](https://github.com/AY000554/ocr_car_plate) |
| Датасет обучения (nomeroff.net) | **CC BY 4.0** | [AUTO.RIA Numberplate Options Dataset](https://nomeroff.net.ua/) |
| Детектор номеров (пайплайн ANPR) | **Apache-2.0** | [AY000554/Car_plate_detecting](https://github.com/AY000554/Car_plate_detecting) |

### Условия использования

- Вы **можете** свободно использовать, изменять и распространять модель в соответствии с GPL-3.0.
- При распространении (включая в составе коммерческого продукта) необходимо:
  - предоставить получателям полный текст лицензии GPL-3.0;
  - указать, что модель основана на [AY000554/ocr_car_plate](https://github.com/AY000554/ocr_car_plate);
  - при публикации производных работ — распространять их также под GPL-3.0.
- Для датасета nomeroff.net требуется **атрибуция** (CC BY 4.0): укажите источник данных при публикации результатов.

Подробные формулировки атрибуции — в файле [NOTICE](NOTICE).

### Кратко

```
EfficientNetV2L_AY000554 — OCR российских ГРЗ (ONNX)
Copyright (C) 2026 1os
Основано на AY000554/ocr_car_plate (GPL-3.0)

Лицензируется под GNU GPL v3.0. См. LICENSE.
Данные обучения: nomeroff.net (CC BY 4.0).
```
